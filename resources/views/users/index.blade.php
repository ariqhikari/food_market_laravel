                    ...
                    <tbody>
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <img src="{{ $user->profile_photo_url }}" alt="{{ $user->name }}" width="150px" class="rounded">
                                </td>
                                ...
                                <td class="border px-6 py-4 text-center">
                                    <a href="{{ route('users.edit', $user) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded">
                                        Edit
                                    </a>
                        ...
                        @empty
                            <tr>
                                <td class="border px-6 py-4 text-center" colspan="5">Data User Tidak Ditemukan!</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
